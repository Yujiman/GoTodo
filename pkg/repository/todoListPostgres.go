...
func NewTodoLstPostgre(db *sqlx.DB) *TodoListPostgres {
...
func (t *TodoListPostgres) Update(userId, listId int, input todo.UpdatedListInput) error {
	...
	logrus.Debugf("UpdateQury = %s", query)
